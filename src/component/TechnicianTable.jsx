            ...
            technicians.map((tech, index) => {
              ...
              return (
                <tr key={tech.id} className="hover:bg-gray-50">
                  <td className="px-4 py-2 border-l-[1px] border-b-[1px] border-[#837958] bg-white">
                    {index + 1}
                  </td>
                  <td className="px-4 py-2 border-b-[1px] border-[#837958] bg-white">
                    {tech.name || '-'}
                  </td>
                  <td className="px-4 py-2 border-b-[1px] border-[#837958] bg-white">
                  ...
                  <td className="px-4 py-2 border-b-[1px] border-[#837958] bg-white leading-none">
                    {tech.userId ? (
                  ...
                  <td className="px-4 py-2 border-r-[1px] border-b-[1px] border-[#837958] bg-white">
                    <button
